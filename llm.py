...
load_dotenv()
llm = OpenAI(model="gpt-4o-mini", temperature=0.7, max_tokens=200)
...
def process_llm(collected_objects, final_context):
    ...
    2. Psychological Rationale: Why this will work
    3. Implementation Steps: How to start
    4. If needed, add [update] for current_state
        Format:
